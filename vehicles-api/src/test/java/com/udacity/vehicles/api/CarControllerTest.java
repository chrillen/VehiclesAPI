...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        var data = resultActions.andReturn().getResponse().getContentAsString();
       Assert.isTrue(data.contains(car.getId().toString()));
    }
    ...
    public void findCar() throws Exception {
        ...
        var resultCar = json.parse(result.getResponse().getContentAsString()).getObject();
        Assert.isTrue(resultCar.getId().equals(car.getId()));
    }
    ...
    public void updateCar() throws Exception {
        ...
        car.setModifiedAt(java.time.LocalDateTime.now());
        mvc.perform(
