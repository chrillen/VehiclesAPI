...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        var optionalcar = this.repository.findById(id);
        ...
        var car = optionalcar.get();
         ...
         var price = this.pricing.getPrice(id);
         car.setPrice(price);

        var location = maps.getAddress(car.getLocation());
        if(location != null)
        ...
        if (car.getId() != null) {
            return repository.findById(car.getId())
                    .map(carToBeUpdated -> {
                        ...
                        carToBeUpdated.setModifiedAt(java.time.LocalDateTime.now());
